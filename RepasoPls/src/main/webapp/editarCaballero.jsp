...
<body>
  	<div class="container mt-5">
	    <h2>Editor de caballero</h2>
	    <form action="EditarCaballero" method="POST">
	      	<input type="number" hidden=true id="id" name="id" value="${caballero.id}">
	      	...
	      	<div class="form-group">
	        	...
	        	<input hidden=true type="file" class="form-control" id="foto" name="foto" value="${caballero.foto}">
	      	</div>
	      	<div class="form-group">
	        	<label for="arma">Arma</label>
	        	<select class="form-control" id="arma" name="arma_id">
	        	<option value="${caballero.arma.nombre}">${caballero.arma.nombre}</option>
	      	...
	      	<div class="form-group">
	        	...
	        	<option value="${caballero.escudo.nombre}">${caballero.escudo.nombre}</option>
